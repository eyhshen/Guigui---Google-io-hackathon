...
window.ShelfieData = (function () {
  const demoProfile = { skinType: null, sensitivities: [], currentActives: [], city: "" };

  const demoInventory = [
    { id: "1", name: "小褐瓶特润修护精华", brand: "Estée Lauder", category: "Serum", keyIngredients: ["二裂酵母", "透明质酸", "多肽"], paoMonths: 24, openedDate: "2025-01-01", expiryDate: "2027-01-01", bottle: { shape: "dropper", colorHex: "#8B5A2B" } },
    { id: "2", name: "Lotion P50 爽肤水", brand: "Biologique Recherche", category: "Toner", keyIngredients: ["水杨酸", "乳酸", "植酸"], paoMonths: 12, openedDate: "2025-10-01", expiryDate: "2026-10-01", bottle: { shape: "bottle", colorHex: "#D2B48C" } },
    { id: "3", name: "修护保湿润肤乳", brand: "CeraVe", category: "Moisturizer", keyIngredients: ["神经酰胺", "透明质酸"], paoMonths: 12, openedDate: "2025-08-01", expiryDate: "2026-08-01", bottle: { shape: "pump", colorHex: "#00599C" } },
    { id: "4", name: "水饱饱 B5 保湿精华", brand: "Drunk Elephant", category: "Serum", keyIngredients: ["维生素B5", "菠萝神经酰胺"], paoMonths: 12, openedDate: "2026-02-01", expiryDate: "2027-02-01", bottle: { shape: "pump", colorHex: "#40E0D0" } },
    { id: "5", name: "无感隐形防晒乳 SPF40", brand: "Supergoop!", category: "Sunscreen", keyIngredients: ["红藻提取物", "草本精粹"], paoMonths: 18, openedDate: "2026-06-01", expiryDate: "2027-12-01", bottle: { shape: "tube", colorHex: "#FCDC4D" } },
    { id: "6", name: "绿茶籽水分菁露", brand: "Innisfree", category: "Serum", keyIngredients: ["绿茶籽", "双重透明质酸"], paoMonths: 12, openedDate: "2025-07-01", expiryDate: "2026-07-01", bottle: { shape: "pump", colorHex: "#4CAF50" } },
  ];
  ...
  const categoryLabels = { All: "全部", Serum: "精华液", Toner: "爽肤水", Moisturizer: "乳液面霜", Sunscreen: "防晒霜", Cleanser: "洁面乳", Cream: "面霜", Lotion: "乳液" };
  const skinTypeLabels = { dry: "干性肌", oily: "油性肌", combination: "混合肌", normal: "中性肌" };
  ...
  const fmtYearMonth = (ym) => { const d = parseM(ym); return `${d.getFullYear()}年${String(d.getMonth() + 1).padStart(2, "0")}月`; };
  ...
  function mockVerdict(profile, inventory, condition) {
    ...
    return { recommendedIds: uniq(rec), avoidIds: uniq(avoid), reason };
  }
  ...
  function mockTravel(profile, inventory, destination, days) {
    ...
    return { selectedIds: chosen.map((p) => p.id), reason };
  }

  return {
    demoProfile, demoInventory, curatedProducts, categoryLabels, skinTypeLabels,
    coreRoutineCategories, routineSteps, quickAsks, accountPromptCopy,
    parseM, addMonths, daysBetween, fmtYearMonth, fmtDate, expiryStatus, monthsOpened, TODAY,
    mockVerdict, mockTravel,
